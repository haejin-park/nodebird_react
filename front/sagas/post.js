...
function likePostAPI(data){
    return axios.patch(`/post/${data}/like`); //개수만 바꾸니까 patch이고 data가 주소에 들어있으니까 안넣어도됨
}
...
function unlikePostAPI(data){
    return axios.delete(`/post/${data}/like`);//POST에 unlike해도 되는데 DELETE하는게 좋음
}
